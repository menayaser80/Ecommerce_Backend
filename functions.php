...
function sendEmail($to , $title , $body){
    $header="From:  support@menay8070@gmail.com"."\n"."CC:menayaser80@gmail.com";
    ...
    function sendGCM($title, $message, $topic, $pageid, $pagename)
{
    ...
    $headers = array(
        'Authorization: key=' . "AAAAky7XURQ:APA91bEAcEJ0S22vIMZcW4VdfgLabW3WLOHJnPyiGRknAmt57u62ZbAYh49zRF0uHdAVZy1RIB43VOFHuig3n_9O9IO8ft-O4K5YBfiyTJRh01yQU2qp4zCeKHBkOmqmDfvr3haT0AOB",
